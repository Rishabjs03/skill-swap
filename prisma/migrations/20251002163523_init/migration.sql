...
-- CreateTable
CREATE TABLE "public"."_ReviewToUser" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,
...
-- CreateIndex
CREATE INDEX "_ReviewToUser_B_index" ON "public"."_ReviewToUser"("B");
...
-- AddForeignKey
ALTER TABLE "public"."_ReviewToUser" ADD CONSTRAINT "_ReviewToUser_A_fkey" FOREIGN KEY ("A") REFERENCES "public"."Review"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."_ReviewToUser" ADD CONSTRAINT "_ReviewToUser_B_fkey" FOREIGN KEY ("B") REFERENCES "public"."user"("id") ON DELETE CASCADE ON UPDATE CASCADE;
